  ...
  <AdminLayout>
    <div class="max-w-7xl mx-auto py-10 px-4">
      <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold text-brown-800">Gestão de Profissionais</h1>
        <Link :href="route('professionals.create')" class="bg-brown-600 text-white px-4 py-2 rounded hover:bg-brown-700">+ Profissional</Link>
      </div>
